...
<section class="content">
	...
	<section class="cure2-outline-section" id="outline">
		...
		<p class="detail f16">歯を抜かない矯正治療の最大のメリットは、歯や骨に低侵襲で比較的短期間で治療が終わることです。 部分的な矯正ではおよそ1年未満、全体的な矯正でも約1年から2年くらいで終了することができます。（人によって個人差があります）<br>
			歯を抜かずに行う矯正では、歯並びをきれいにしたり奥歯の噛み合わせを改善するために、奥歯の歯列を拡大させIPRやディスキングと言われる技術で 歯と歯の間を専用の器具でわずかに（0.2mm~0.5mm程度）削りながら歯を動かすスペースを作っていきます。 
			また、奥歯を動かす際には歯にかけるゴムを使用して噛み合わせを改善していきます。 これにより、歯1本1本が動いていきます。そして最終的に、前歯の歯並び、奥歯の噛み合わせが改善します。（骨格的な問題や口元、顔貌の改善を行う必要がある場合には抜歯をしなければならないこともあります）
