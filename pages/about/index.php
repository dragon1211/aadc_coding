...
<section class="content">
    ...
    <div class="about-mainvisual">
        <div class="about-container">
            ...
            <p class="about-mainvisual__desc">
                ...
                皆様が感じているように、歯の健康は日々の生活を快適に過ごし、見た目と気持ちの若さを維持するためにとても大切です。<br>
                <br>
                私自身も、開院から１５年が経過した今、歯は見た目の美しさを左右するだけでなく全身の健康につながる体の一部であること、<br>
                心の健康にも深く関わっていることを、あらためて強く感じています。<br>
                <br>
    ...
    <!-- outline comment -->
    <div class="about-outline-comment">
        <div class="about-container">
            <p>
    ...
    <!-- proportion smile -->
    <div class="about-proportion-smile">
        <div class="about-container">
